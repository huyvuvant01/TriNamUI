...
// Type: Kendo.Mvc.UI.DropDownTreeItemModel
...
{
  public class DropDownTreeItemModel : IHierarchicalItem
  {
    public DropDownTreeItemModel()
    {
      this.Enabled = true;
      this.Encoded = true;
      this.Items = new List<DropDownTreeItemModel>();
    ...
    public List<DropDownTreeItemModel> Items { get; set; }
