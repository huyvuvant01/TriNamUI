...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisMinorGridLinesSettings`1
...
{
  public class StockChartNavigatorCategoryAxisMinorGridLinesSettings<T> where T : class
  {
