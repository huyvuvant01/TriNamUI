...
// Type: Kendo.Mvc.UI.MultiColumnComboBox
...
{
  public class MultiColumnComboBox : WidgetBase, IFormEditor
  {
    ...
    public MultiColumnComboBox(ViewContext viewContext)
      : base(viewContext)
    {
...
label_9:
      ...
      if (this.DataSource.ServerFiltering && !this.DataSource.Transport.Read.Data.HasValue())
      {
        ...
        if (!(type.GetValueOrDefault() == dataSourceType1 & type.HasValue))
        {
          ...
          if (!(type.GetValueOrDefault() == dataSourceType2 & type.HasValue))
            ...
            {
              HandlerName = "function() { return kendo.ui.MultiColumnComboBox.requestData(jQuery(\"" + MultiColumnComboBox.EscapeRegex.Replace(this.Selector, "\\\\$1") + "\")); }"
            };
        }
      }
      writer.Write(this.Initializer.Initialize(this.Selector, nameof (MultiColumnComboBox), this.Serialize()));
    }
    ...
    public List<MultiColumnComboBoxColumn> Columns { get; set; } = new List<MultiColumnComboBoxColumn>();
    ...
    public MultiColumnComboBoxMessagesSettings Messages { get; } = new MultiColumnComboBoxMessagesSettings();
    ...
    public MultiColumnComboBoxPopupSettings Popup { get; } = new MultiColumnComboBoxPopupSettings();
    ...
    public MultiColumnComboBoxVirtualSettings Virtual { get; } = new MultiColumnComboBoxVirtualSettings();
    ...
    protected override Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source1 = this.Columns.Select<MultiColumnComboBoxColumn, Dictionary<string, object>>((Func<MultiColumnComboBoxColumn, Dictionary<string, object>>) (i => i.Serialize()));
      if (source1.Any<Dictionary<string, object>>())
        dictionary1["columns"] = (object) source1;
      ...
      Dictionary<string, object> source4 = this.Virtual.Serialize();
      if (source4.Any<KeyValuePair<string, object>>())
        dictionary1["virtual"] = (object) source4;
