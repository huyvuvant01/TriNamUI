...
// Type: Kendo.Mvc.UI.UploadAsyncSettings
...
namespace Kendo.Mvc.UI
{
  ...
  {
    public INavigatable Save { get; } = (INavigatable) new RequestSettings();

    public INavigatable Remove { get; } = (INavigatable) new RequestSettings();
    ...
    public Dictionary<string, object> Serialize()
    {
      ...
      if (this.Save.HasValue())
      {
        dictionary["saveUrl"] = (object) this.UrlDecoder(this.Save.GenerateUrl(this.ViewContext, this.UrlGenerator));
        if (this.Remove.HasValue())
          dictionary["removeUrl"] = (object) this.UrlDecoder(this.Remove.GenerateUrl(this.ViewContext, this.UrlGenerator));
      }
      return dictionary;
    }
