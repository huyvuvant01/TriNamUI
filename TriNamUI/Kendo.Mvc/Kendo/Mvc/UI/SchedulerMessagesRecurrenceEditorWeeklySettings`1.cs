...
// Type: Kendo.Mvc.UI.SchedulerMessagesRecurrenceEditorWeeklySettings`1
...
{
  public class SchedulerMessagesRecurrenceEditorWeeklySettings<T> where T : class, ISchedulerEvent
  {
