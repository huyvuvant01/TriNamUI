...
// Type: Kendo.Mvc.UI.DiagramEditableSettingsTool`2
...
{
  public class DiagramEditableSettingsTool<TShapeModel, TConnectionModel>
    ...
    where TConnectionModel : class
  {
    ...
    public List<DiagramEditableSettingsToolButton<TShapeModel, TConnectionModel>> Buttons { get; set; } = new List<DiagramEditableSettingsToolButton<TShapeModel, TConnectionModel>>();
    ...
    public List<DiagramEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>> MenuButtons { get; set; } = new List<DiagramEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>>();
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source1 = this.Buttons.Select<DiagramEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
      ...
      IEnumerable<Dictionary<string, object>> source2 = this.MenuButtons.Select<DiagramEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
