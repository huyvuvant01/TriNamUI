...
// Type: Kendo.Mvc.UI.Fluent.FilterableSignalRDataSourceBuilder`1
...
namespace Kendo.Mvc.UI.Fluent
{
    ...
    where TModel : class
  {
    ...
    public override SignalRDataSourceBuilder<TModel> Sort(
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public override SignalRDataSourceBuilder<TModel> Group(
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public override SignalRDataSourceBuilder<TModel> Aggregates(
