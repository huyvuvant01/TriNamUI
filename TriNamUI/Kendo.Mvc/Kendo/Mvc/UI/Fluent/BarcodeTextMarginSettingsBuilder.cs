...
// Type: Kendo.Mvc.UI.Fluent.BarcodeTextMarginSettingsBuilder
...
{
  public class BarcodeTextMarginSettingsBuilder
  {
    public BarcodeTextMarginSettingsBuilder(BarcodeTextMarginSettings container) => this.Container = container;

    protected BarcodeTextMarginSettings Container { get; private set; }
