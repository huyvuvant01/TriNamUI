...
// Type: Kendo.Mvc.UI.Fluent.ChartSeriesMarginSettingsBuilder`1
...
{
  public class ChartSeriesMarginSettingsBuilder<T> where T : class
  {
    public ChartSeriesMarginSettingsBuilder(ChartSeriesMarginSettings<T> container) => this.Container = container;

    protected ChartSeriesMarginSettings<T> Container { get; private set; }
