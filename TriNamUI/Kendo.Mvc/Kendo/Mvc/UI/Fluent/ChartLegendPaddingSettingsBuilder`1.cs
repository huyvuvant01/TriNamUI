...
// Type: Kendo.Mvc.UI.Fluent.ChartLegendPaddingSettingsBuilder`1
...
{
  public class ChartLegendPaddingSettingsBuilder<T> where T : class
  {
    public ChartLegendPaddingSettingsBuilder(ChartLegendPaddingSettings<T> container) => this.Container = container;

    protected ChartLegendPaddingSettings<T> Container { get; private set; }
