...
// Type: Kendo.Mvc.UI.Fluent.SpreadsheetTopFilterBuilder
...
namespace Kendo.Mvc.UI.Fluent
{
  ...
  {
    public SpreadsheetTopFilterBuilder(SpreadsheetSheetFilterSettingsColumn container) => this.Container = container;
    ...
    public SpreadsheetTopFilterBuilder Type(
      SpreadsheetTopFilterType value)
    {
