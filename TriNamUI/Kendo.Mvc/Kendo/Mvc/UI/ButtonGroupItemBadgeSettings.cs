...
// Type: Kendo.Mvc.UI.ButtonGroupItemBadgeSettings
...
{
  public class ButtonGroupItemBadgeSettings
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.TemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.ButtonGroup.IdPrefix, (object) this.TemplateId)
        };
