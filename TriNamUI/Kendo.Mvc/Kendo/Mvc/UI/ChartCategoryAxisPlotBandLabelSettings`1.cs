...
// Type: Kendo.Mvc.UI.ChartCategoryAxisPlotBandLabelSettings`1
...
{
  public class ChartCategoryAxisPlotBandLabelSettings<T> where T : class
  {
    ...
    public ChartCategoryAxisPlotBandLabelBorderSettings<T> Border { get; } = new ChartCategoryAxisPlotBandLabelBorderSettings<T>();

    public string Color { get; set; }

    public string Font { get; set; }

    public ChartCategoryAxisPlotBandLabelMarginSettings<T> Margin { get; } = new ChartCategoryAxisPlotBandLabelMarginSettings<T>();

    public ChartCategoryAxisPlotBandLabelPaddingSettings<T> Padding { get; } = new ChartCategoryAxisPlotBandLabelPaddingSettings<T>();
