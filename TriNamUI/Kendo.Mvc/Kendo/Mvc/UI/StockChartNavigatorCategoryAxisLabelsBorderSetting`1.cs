...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisLabelsBorderSettings`1
...
{
  public class StockChartNavigatorCategoryAxisLabelsBorderSettings<T> where T : class
  {
