...
// Type: Kendo.Mvc.UI.ChartSeriesMarkersFromBorderSettings`1
...
{
  public class ChartSeriesMarkersFromBorderSettings<T> where T : class
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if ((widthHandler != null ? (widthHandler.HasValue() ? 1 : 0) : 0) != 0)
        dictionary["width"] = (object) this.WidthHandler;
