...
// Type: Kendo.Mvc.UI.PDFViewerToolbarSettingsItem
...
{
  public class PDFViewerToolbarSettingsItem
  {
    public PDFViewerToolbarSettingsItem(string toolName = null) => this.Name = toolName;
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.TemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.PDFViewer.IdPrefix, (object) this.TemplateId)
        };
