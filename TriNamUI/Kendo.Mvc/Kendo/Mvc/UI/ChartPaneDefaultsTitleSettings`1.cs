...
// Type: Kendo.Mvc.UI.ChartPaneDefaultsTitleSettings`1
...
{
  public class ChartPaneDefaultsTitleSettings<T> where T : class
  {
    public Dictionary<string, object> Serialize() => this.SerializeSettings();

    public string Background { get; set; }

    public ChartPaneDefaultsTitleBorderSettings<T> Border { get; } = new ChartPaneDefaultsTitleBorderSettings<T>();

    public string Color { get; set; }

    public string Font { get; set; }

    public ChartPaneDefaultsTitleMarginSettings<T> Margin { get; } = new ChartPaneDefaultsTitleMarginSettings<T>();
