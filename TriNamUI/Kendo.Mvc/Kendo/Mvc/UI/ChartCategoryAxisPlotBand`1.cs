...
// Type: Kendo.Mvc.UI.ChartCategoryAxisPlotBand`1
...
{
  public class ChartCategoryAxisPlotBand<T> where T : class
  {
    ...
    public ChartCategoryAxisPlotBandLabelSettings<T> Label { get; } = new ChartCategoryAxisPlotBandLabelSettings<T>();
