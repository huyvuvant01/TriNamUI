...
// Type: Kendo.Mvc.UI.TreeViewCheckboxesSettings
...
{
  public class TreeViewCheckboxesSettings
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.TemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.TreeView.IdPrefix, (object) this.TemplateId)
        };
