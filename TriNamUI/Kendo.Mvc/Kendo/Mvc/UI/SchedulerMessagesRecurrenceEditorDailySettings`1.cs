...
// Type: Kendo.Mvc.UI.SchedulerMessagesRecurrenceEditorDailySettings`1
...
{
  public class SchedulerMessagesRecurrenceEditorDailySettings<T> where T : class, ISchedulerEvent
  {
