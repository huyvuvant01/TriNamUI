...
// Type: Kendo.Mvc.UI.ChartValueAxisPlotBandLabelSettings`1
...
{
  public class ChartValueAxisPlotBandLabelSettings<T> where T : class
  {
    ...
    public ChartValueAxisPlotBandLabelBorderSettings<T> Border { get; } = new ChartValueAxisPlotBandLabelBorderSettings<T>();

    public string Color { get; set; }

    public string Font { get; set; }

    public ChartValueAxisPlotBandLabelMarginSettings<T> Margin { get; } = new ChartValueAxisPlotBandLabelMarginSettings<T>();

    public ChartValueAxisPlotBandLabelPaddingSettings<T> Padding { get; } = new ChartValueAxisPlotBandLabelPaddingSettings<T>();
