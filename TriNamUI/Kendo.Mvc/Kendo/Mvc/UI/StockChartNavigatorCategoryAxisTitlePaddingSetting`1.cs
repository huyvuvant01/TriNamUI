...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisTitlePaddingSettings`1
...
{
  public class StockChartNavigatorCategoryAxisTitlePaddingSettings<T> where T : class
  {
