...
// Type: Kendo.Mvc.UI.FilterOperatorsStringSettings`1
...
{
  public class FilterOperatorsStringSettings<T> : OperatorsBase where T : class
  {
    public FilterOperatorsStringSettings() => this.Operators = (IDictionary<string, string>) new Dictionary<string, string>();
