...
// Type: Kendo.Mvc.UI.DiagramShapeDefaultsSettingsConnector`2
...
{
  public class DiagramShapeDefaultsSettingsConnector<TShapeModel, TConnectionModel>
    ...
    where TConnectionModel : class
  {
    ...
    public DiagramShapeDefaultsConnectorHoverSettings<TShapeModel, TConnectionModel> Hover { get; } = new DiagramShapeDefaultsConnectorHoverSettings<TShapeModel, TConnectionModel>();

    public DiagramShapeDefaultsConnectorFillSettings<TShapeModel, TConnectionModel> Fill { get; } = new DiagramShapeDefaultsConnectorFillSettings<TShapeModel, TConnectionModel>();

    public DiagramShapeDefaultsConnectorStrokeSettings<TShapeModel, TConnectionModel> Stroke { get; } = new DiagramShapeDefaultsConnectorStrokeSettings<TShapeModel, TConnectionModel>();
