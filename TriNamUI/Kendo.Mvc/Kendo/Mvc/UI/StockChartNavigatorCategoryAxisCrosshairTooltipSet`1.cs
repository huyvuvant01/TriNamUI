...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisCrosshairTooltipSettings`1
...
{
  public class StockChartNavigatorCategoryAxisCrosshairTooltipSettings<T> where T : class
  {
