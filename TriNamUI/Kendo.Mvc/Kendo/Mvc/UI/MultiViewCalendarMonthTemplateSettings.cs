...
// Type: Kendo.Mvc.UI.MultiViewCalendarMonthTemplateSettings
...
{
  public class MultiViewCalendarMonthTemplateSettings
  {
    public Dictionary<string, object> Serialize()
    {
      ...
      if (this.ContentId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.MultiViewCalendar.IdPrefix, (object) this.ContentId)
        };
      ...
      if (this.EmptyId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.MultiViewCalendar.IdPrefix, (object) this.EmptyId)
        };
      ...
      if (this.WeekNumberId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.MultiViewCalendar.IdPrefix, (object) this.WeekNumberId)
        };
    ...
    public MultiViewCalendar MultiViewCalendar { get; set; }
