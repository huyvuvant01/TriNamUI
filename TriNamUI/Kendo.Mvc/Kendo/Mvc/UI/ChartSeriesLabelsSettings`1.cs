...
// Type: Kendo.Mvc.UI.ChartSeriesLabelsSettings`1
...
{
  public class ChartSeriesLabelsSettings<T> where T : class
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      Dictionary<string, object> source5 = this.To.Serialize();
      if (source5.Any<KeyValuePair<string, object>>())
        dictionary1["to"] = (object) source5;
