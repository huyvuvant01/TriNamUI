...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisLabelsPaddingSettings`1
...
{
  public class StockChartNavigatorCategoryAxisLabelsPaddingSettings<T> where T : class
  {
