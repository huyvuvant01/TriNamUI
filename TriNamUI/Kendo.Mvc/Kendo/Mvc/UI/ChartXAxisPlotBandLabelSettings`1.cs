...
// Type: Kendo.Mvc.UI.ChartXAxisPlotBandLabelSettings`1
...
{
  public class ChartXAxisPlotBandLabelSettings<T> where T : class
  {
    ...
    public ChartXAxisPlotBandLabelBorderSettings<T> Border { get; } = new ChartXAxisPlotBandLabelBorderSettings<T>();

    public string Color { get; set; }

    public string Font { get; set; }

    public ChartXAxisPlotBandLabelMarginSettings<T> Margin { get; } = new ChartXAxisPlotBandLabelMarginSettings<T>();

    public ChartXAxisPlotBandLabelPaddingSettings<T> Padding { get; } = new ChartXAxisPlotBandLabelPaddingSettings<T>();
