...
// Type: Kendo.Mvc.UI.ImageEditorToolbarSettingsItem
...
{
  public class ImageEditorToolbarSettingsItem
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.TemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.ImageEditor.IdPrefix, (object) this.TemplateId)
        };
