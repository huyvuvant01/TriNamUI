...
// Type: Kendo.Mvc.UI.FilterOperatorsDateSettings`1
...
{
  public class FilterOperatorsDateSettings<T> : OperatorsBase where T : class
  {
    public FilterOperatorsDateSettings() => this.Operators = (IDictionary<string, string>) new Dictionary<string, string>();
