...
// Type: Kendo.Mvc.UI.TreeListColumnSortableSettings`1
...
{
  public class TreeListColumnSortableSettings<T> where T : class
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      ClientHandlerDescriptor compare = this.Compare;
