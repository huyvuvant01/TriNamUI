...
// Type: Kendo.Mvc.Infrastructure.Implementation.Expressions.FilterExpressionBuilder
...
namespace Kendo.Mvc.Infrastructure.Implementation.Expressions
{
  public abstract class FilterExpressionBuilder : ExpressionBuilderBase
  {
    ...
    public LambdaExpression CreateFilterExpression() => Expression.Lambda(this.CreateBodyExpression(), this.ParameterExpression);
  }
}
