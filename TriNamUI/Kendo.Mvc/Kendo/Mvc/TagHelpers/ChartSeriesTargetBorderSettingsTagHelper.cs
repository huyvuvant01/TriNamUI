...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesTargetBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "target", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesTargetBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesTargetSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesTargetSettingsTagHelper).Border = this;
    }
