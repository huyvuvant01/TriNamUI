...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisTitleSettingsTagHelper
...
{
  [HtmlTargetElement("chart-x-axis-item-title", ParentTag = "x-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartXAxisTitleSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisTagHelper).Title = this;
    }
    ...
    public ChartXAxisTitleBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartXAxisTitleMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartXAxisTitlePaddingSettingsTagHelper Padding { get; set; }
