...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesDefaultsBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "series-defaults", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesDefaultsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesDefaultsSettingsTagHelper).Border = this;
    }
