...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesTooltipSettingsTagHelper
...
{
  [HtmlTargetElement("tooltip", ParentTag = "series-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-series-tooltip-border", new string[] {"chart-series-tooltip-padding"})]
  [SuppressTagRendering]
  public class ChartSeriesTooltipSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesTagHelper).Tooltip = this;
    }
    ...
    public ChartSeriesTooltipBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartSeriesTooltipPaddingSettingsTagHelper Padding { get; set; }
