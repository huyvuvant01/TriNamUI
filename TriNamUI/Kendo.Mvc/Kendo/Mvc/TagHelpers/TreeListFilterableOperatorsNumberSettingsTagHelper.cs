...
// Type: Kendo.Mvc.TagHelpers.TreeListFilterableOperatorsNumberSettingsTagHelper
...
{
  [HtmlTargetElement("number", ParentTag = "treelist-filterable-operators", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class TreeListFilterableOperatorsNumberSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TreeListFilterableOperatorsSettingsTagHelper).Number = this;
    }
