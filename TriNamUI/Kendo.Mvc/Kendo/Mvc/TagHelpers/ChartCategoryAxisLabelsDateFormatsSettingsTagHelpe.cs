...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisLabelsDateFormatsSettingsTagHelper
...
{
  [HtmlTargetElement("chart-category-axis-labels-date-formats", ParentTag = "labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartCategoryAxisLabelsDateFormatsSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisLabelsSettingsTagHelper).DateFormats = this;
    }
