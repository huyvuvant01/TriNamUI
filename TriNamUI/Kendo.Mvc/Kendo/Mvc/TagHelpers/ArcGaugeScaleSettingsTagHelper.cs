...
// Type: Kendo.Mvc.TagHelpers.ArcGaugeScaleSettingsTagHelper
...
{
  [HtmlTargetElement("scale", ParentTag = "kendo-arcgauge", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("labels", new string[] {"major-ticks", "minor-ticks"})]
  [SuppressTagRendering]
  public class ArcGaugeScaleSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ArcGaugeTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ArcGaugeTagHelper).Scale = this;
    }
    ...
    public ArcGaugeScaleLabelsSettingsTagHelper Labels { get; set; }

    [HtmlAttributeNotBound]
    public ArcGaugeScaleMajorTicksSettingsTagHelper MajorTicks { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ArcGaugeScaleMinorTicksSettingsTagHelper MinorTicks { get; set; }
