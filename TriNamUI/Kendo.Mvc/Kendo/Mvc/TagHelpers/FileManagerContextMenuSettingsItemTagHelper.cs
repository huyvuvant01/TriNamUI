...
// Type: Kendo.Mvc.TagHelpers.FileManagerContextMenuSettingsItemTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class FileManagerContextMenuSettingsItemTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      Type type = typeof (FileManagerContextMenuSettingsItemsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FileManagerContextMenuSettingsItemsTagHelper).Add(this);
    }
