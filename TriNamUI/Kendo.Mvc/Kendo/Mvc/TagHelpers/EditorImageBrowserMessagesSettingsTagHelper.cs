...
// Type: Kendo.Mvc.TagHelpers.EditorImageBrowserMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "image-browser", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class EditorImageBrowserMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorImageBrowserSettingsTagHelper).Messages = this;
    }
