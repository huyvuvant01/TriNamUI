...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesLabelsBorderSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-labels-border", ParentTag = "labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesLabelsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesLabelsSettingsTagHelper).Border = this;
    }
