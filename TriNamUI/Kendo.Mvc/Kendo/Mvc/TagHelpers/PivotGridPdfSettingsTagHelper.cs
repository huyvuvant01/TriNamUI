...
// Type: Kendo.Mvc.TagHelpers.PivotGridPdfSettingsTagHelper
...
{
  [HtmlTargetElement("pdf", ParentTag = "kendo-pivotgrid", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("pivotgrid-pdf-margin", new string[] {})]
  [SuppressTagRendering]
  public class PivotGridPdfSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as PivotGridTagHelper).Pdf = this;
    }
    ...
    public PivotGridPdfMarginSettingsTagHelper Margin { get; set; }
