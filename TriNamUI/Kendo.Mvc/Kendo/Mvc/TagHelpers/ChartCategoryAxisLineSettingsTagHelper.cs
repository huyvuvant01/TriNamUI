...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisLineSettingsTagHelper
...
{
  [HtmlTargetElement("line", ParentTag = "category-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartCategoryAxisLineSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisTagHelper).Line = this;
    }
