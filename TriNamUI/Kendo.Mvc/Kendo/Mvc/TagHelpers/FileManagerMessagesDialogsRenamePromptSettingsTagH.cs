...
// Type: Kendo.Mvc.TagHelpers.FileManagerMessagesDialogsRenamePromptSettingsTagHelper
...
{
  [HtmlTargetElement("rename-prompt", ParentTag = "dialogs", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class FileManagerMessagesDialogsRenamePromptSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FileManagerMessagesDialogsSettingsTagHelper).RenamePrompt = this;
    }
