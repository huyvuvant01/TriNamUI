...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesDefaultsLabelsToSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-defaults-labels-to", ParentTag = "labels", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartSeriesDefaultsLabelsToSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesDefaultsLabelsSettingsTagHelper).To = this;
    }
    ...
    public ChartSeriesDefaultsLabelsToBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartSeriesDefaultsLabelsToMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartSeriesDefaultsLabelsToPaddingSettingsTagHelper Padding { get; set; }
