...
// Type: Kendo.Mvc.TagHelpers.ImageEditorMessagesPanesResizeSettingsTagHelper
...
{
  [HtmlTargetElement("resize", ParentTag = "panes", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ImageEditorMessagesPanesResizeSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ImageEditorMessagesPanesSettingsTagHelper).Resize = this;
    }
