...
// Type: Kendo.Mvc.TagHelpers.ButtonBadgeSettingsTagHelper
...
{
  [HtmlTargetElement("badge", ParentTag = "kendo-button", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ButtonBadgeSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ButtonTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ButtonTagHelper).Badge = this;
    }
