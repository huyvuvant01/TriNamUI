...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesLabelsToSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-labels-to", ParentTag = "labels", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartSeriesLabelsToSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesLabelsSettingsTagHelper).To = this;
    }
    ...
    public ChartSeriesLabelsToBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartSeriesLabelsToMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartSeriesLabelsToPaddingSettingsTagHelper Padding { get; set; }
