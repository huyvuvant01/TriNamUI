...
// Type: Kendo.Mvc.TagHelpers.MapControlsZoomSettingsTagHelper
...
{
  [HtmlTargetElement("zoom", ParentTag = "controls", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class MapControlsZoomSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as MapControlsSettingsTagHelper).Zoom = this;
    }
