...
// Type: Kendo.Mvc.TagHelpers.DatePickerTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  [HtmlTargetElement("datepicker-editor", ParentTag = "form-item")]
  [OutputElementHint("input")]
  public class DatePickerTagHelper : TagHelperBase, IKendoFormEditor
  {
    public 
    #nullable disable
    ...
    public DatePickerTagHelper rootTagHelper { get; set; }

    [HtmlAttributeNotBound]
    public bool IsNested { get; set; }

    public DatePickerTagHelper(IKendoHtmlGenerator generator)
      : base(generator)
    {
    ...
    protected override string GetInitializationScript() => this.Initializer.Initialize(this.Selector, "DatePicker", (IDictionary<string, object>) this.Serialize());
    ...
    public bool TryAddToForm(TagHelperContext context)
    {
      foreach (KeyValuePair<object, object> keyValuePair in context.Items.Reverse<KeyValuePair<object, object>>())
      {
        if (keyValuePair.Value is FormItemTagHelper formItemTagHelper1)
        {
          ...
          formItemTagHelper1.Editor = "DatePicker";
          return true;
        }
      }
      return false;
    ...
    [HtmlAttributeNotBound]
    public DatePickerPopupSettingsTagHelper Popup { get; set; }
