...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisTagHelper
...
{
  [HtmlTargetElement("y-axis-item", ParentTag = "y-axis", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("crosshair", new string[] {"labels", "line", "major-grid-lines", "minor-grid-lines", "minor-ticks", "major-ticks", "plot-bands", "chart-y-axis-item-title", "notes"})]
  [SuppressTagRendering]
  public class ChartYAxisTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      System.Type type = typeof (ChartYAxisTagHelperCollection);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisTagHelperCollection).Add(this);
    }
    ...
    public ChartYAxisCrosshairSettingsTagHelper Crosshair { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisLabelsSettingsTagHelper Labels { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisLineSettingsTagHelper Line { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisMajorGridLinesSettingsTagHelper MajorGridLines { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisMinorGridLinesSettingsTagHelper MinorGridLines { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisMinorTicksSettingsTagHelper MinorTicks { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisMajorTicksSettingsTagHelper MajorTicks { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartYAxisPlotBandsTagHelper PlotBands { get; set; }

    public bool? Reverse { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisTitleSettingsTagHelper Title { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartYAxisNotesSettingsTagHelper Notes { get; set; }
    ...
    internal Dictionary<string, object> SerializeSettings()
    {
      ...
      {
        IEnumerable<Dictionary<string, object>> source = this.PlotBands.Select<ChartYAxisPlotBandTagHelper, Dictionary<string, object>>((Func<ChartYAxisPlotBandTagHelper, Dictionary<string, object>>) (i => i.Serialize()));
