...
// Type: Kendo.Mvc.TagHelpers.PivotConfiguratorMessagesFieldMenuSettingsTagHelper
...
{
  [HtmlTargetElement("pivotconfigurator-messages-field-menu", ParentTag = "messages", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("operators", new string[] {})]
  [SuppressTagRendering]
  public class PivotConfiguratorMessagesFieldMenuSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (PivotConfiguratorMessagesSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as PivotConfiguratorMessagesSettingsTagHelper).FieldMenu = this;
    }
    ...
    public PivotConfiguratorMessagesFieldMenuOperatorsSettingsTagHelper Operators { get; set; }
