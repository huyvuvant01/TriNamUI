...
// Type: Kendo.Mvc.TagHelpers.ChartPaneDefaultsBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "pane-defaults", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartPaneDefaultsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartPaneDefaultsSettingsTagHelper).Border = this;
    }
