...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisPlotBandLabelSettingsTagHelper
...
{
  [HtmlTargetElement("label", ParentTag = "chart-y-axis-plot-bands", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartYAxisPlotBandLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartYAxisPlotBandTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisPlotBandTagHelper).Label = this;
    }
    ...
    public ChartYAxisPlotBandLabelBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartYAxisPlotBandLabelMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisPlotBandLabelPaddingSettingsTagHelper Padding { get; set; }
