...
// Type: Kendo.Mvc.TagHelpers.GanttMessagesEditorSettingsTagHelper
...
{
  [HtmlTargetElement("editor", ParentTag = "messages", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class GanttMessagesEditorSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as GanttMessagesSettingsTagHelper).Editor = this;
    }
