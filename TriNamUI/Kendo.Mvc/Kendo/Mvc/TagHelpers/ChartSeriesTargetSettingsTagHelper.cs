...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesTargetSettingsTagHelper
...
{
  [HtmlTargetElement("target", ParentTag = "series-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"line"})]
  [SuppressTagRendering]
  public class ChartSeriesTargetSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesTagHelper).Target = this;
    }

    public Dictionary<string, object> Serialize() => this.SerializeSettings();

    [HtmlAttributeNotBound]
    public ChartSeriesTargetBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartSeriesTargetLineSettingsTagHelper Line { get; set; }
