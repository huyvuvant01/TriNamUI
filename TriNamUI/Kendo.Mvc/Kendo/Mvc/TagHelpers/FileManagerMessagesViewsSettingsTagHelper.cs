...
// Type: Kendo.Mvc.TagHelpers.FileManagerMessagesViewsSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class FileManagerMessagesViewsSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FileManagerMessagesSettingsTagHelper).Views = this;
    }
