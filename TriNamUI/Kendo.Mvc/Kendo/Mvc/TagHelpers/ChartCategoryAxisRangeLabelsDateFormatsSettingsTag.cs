...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisRangeLabelsDateFormatsSettingsTagHelper
...
{
  [HtmlTargetElement("date-formats", ParentTag = "range-labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartCategoryAxisRangeLabelsDateFormatsSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartCategoryAxisRangeLabelsSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisRangeLabelsSettingsTagHelper).DateFormats = this;
    }
