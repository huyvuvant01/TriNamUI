...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisNotesLabelSettingsTagHelper
...
{
  [HtmlTargetElement("chart-category-axis-notes-label", ParentTag = "notes", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {})]
  [SuppressTagRendering]
  public class ChartCategoryAxisNotesLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartCategoryAxisNotesSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisNotesSettingsTagHelper).Label = this;
    }
    ...
    public ChartCategoryAxisNotesLabelBorderSettingsTagHelper Border { get; set; }
