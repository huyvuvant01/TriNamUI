...
// Type: Kendo.Mvc.TagHelpers.SpreadsheetExcelSettingsTagHelper
...
{
  [HtmlTargetElement("excel", ParentTag = "kendo-spreadsheet", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class SpreadsheetExcelSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as SpreadsheetTagHelper).Excel = this;
    }
