...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisMinorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("minor-grid-lines", ParentTag = "category-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartCategoryAxisMinorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisTagHelper).MinorGridLines = this;
    }
