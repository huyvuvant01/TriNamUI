...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesDefaultsNotesLabelSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-defaults-notes-label", ParentTag = "notes", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {})]
  [SuppressTagRendering]
  public class ChartSeriesDefaultsNotesLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesDefaultsNotesSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesDefaultsNotesSettingsTagHelper).Label = this;
    }
    ...
    public ChartSeriesDefaultsNotesLabelBorderSettingsTagHelper Border { get; set; }
