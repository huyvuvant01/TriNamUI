...
// Type: Kendo.Mvc.TagHelpers.TreeListFilterableOperatorsDateSettingsTagHelper
...
{
  [HtmlTargetElement("date", ParentTag = "treelist-filterable-operators", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class TreeListFilterableOperatorsDateSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TreeListFilterableOperatorsSettingsTagHelper).Date = this;
    }
