...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisCrosshairTooltipSettingsTagHelper
...
{
  [HtmlTargetElement("chart-category-axis-crosshair-tooltip", ParentTag = "crosshair", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"padding"})]
  [SuppressTagRendering]
  public class ChartCategoryAxisCrosshairTooltipSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartCategoryAxisCrosshairSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisCrosshairSettingsTagHelper).Tooltip = this;
    }
    ...
    public ChartCategoryAxisCrosshairTooltipBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartCategoryAxisCrosshairTooltipPaddingSettingsTagHelper Padding { get; set; }
