...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisNotesLabelSettingsTagHelper
...
{
  [HtmlTargetElement("chart-x-axis-notes-label", ParentTag = "notes", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {})]
  [SuppressTagRendering]
  public class ChartXAxisNotesLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartXAxisNotesSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisNotesSettingsTagHelper).Label = this;
    }
    ...
    public ChartXAxisNotesLabelBorderSettingsTagHelper Border { get; set; }
