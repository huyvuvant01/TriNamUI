...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisPlotBandLabelSettingsTagHelper
...
{
  [HtmlTargetElement("label", ParentTag = "chart-value-axis-plot-bands", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartValueAxisPlotBandLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartValueAxisPlotBandTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisPlotBandTagHelper).Label = this;
    }
    ...
    public ChartValueAxisPlotBandLabelBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartValueAxisPlotBandLabelMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartValueAxisPlotBandLabelPaddingSettingsTagHelper Padding { get; set; }
