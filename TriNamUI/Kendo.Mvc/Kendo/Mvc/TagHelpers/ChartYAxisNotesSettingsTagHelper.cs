...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisNotesSettingsTagHelper
...
{
  [HtmlTargetElement("notes", ParentTag = "y-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-y-axis-notes-icon", new string[] {"chart-y-axis-notes-label", "chart-y-axis-notes-line"})]
  [SuppressTagRendering]
  public class ChartYAxisNotesSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisTagHelper).Notes = this;
    }
    ...
    public ChartYAxisNotesIconSettingsTagHelper Icon { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisNotesLabelSettingsTagHelper Label { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisNotesLineSettingsTagHelper Line { get; set; }
