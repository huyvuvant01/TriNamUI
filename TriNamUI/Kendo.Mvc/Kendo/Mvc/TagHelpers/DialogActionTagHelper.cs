...
// Type: Kendo.Mvc.TagHelpers.DialogActionTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class DialogActionTagHelper : TagHelperCollectionItemBase
  {
    public 
    #nullable disable
    ...
    {
      Type type = typeof (DialogActionsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as DialogActionsTagHelper).Add(this);
    }
