...
// Type: Kendo.Mvc.TagHelpers.TreeViewMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "kendo-treeview", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class TreeViewMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TreeViewTagHelper).Messages = this;
    }
