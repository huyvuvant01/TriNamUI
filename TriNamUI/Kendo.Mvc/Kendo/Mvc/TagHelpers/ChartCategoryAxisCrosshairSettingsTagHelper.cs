...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisCrosshairSettingsTagHelper
...
{
  [HtmlTargetElement("crosshair", ParentTag = "category-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-category-axis-crosshair-tooltip", new string[] {})]
  [SuppressTagRendering]
  public class ChartCategoryAxisCrosshairSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisTagHelper).Crosshair = this;
    }
    ...
    public ChartCategoryAxisCrosshairTooltipSettingsTagHelper Tooltip { get; set; }
