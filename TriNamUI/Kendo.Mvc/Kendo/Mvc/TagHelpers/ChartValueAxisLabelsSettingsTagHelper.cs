...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisLabelsSettingsTagHelper
...
{
  [HtmlTargetElement("labels", ParentTag = "value-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-value-axis-labels-border", new string[] {"chart-value-axis-labels-margin", "chart-value-axis-labels-padding", "chart-value-axis-labels-rotation"})]
  [SuppressTagRendering]
  public class ChartValueAxisLabelsSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisTagHelper).Labels = this;
    }
    ...
    public ChartValueAxisLabelsBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartValueAxisLabelsMarginSettingsTagHelper Margin { get; set; }

    public bool? Mirror { get; set; }

    [HtmlAttributeNotBound]
    public ChartValueAxisLabelsPaddingSettingsTagHelper Padding { get; set; }

    [HtmlAttributeNotBound]
    public ChartValueAxisLabelsRotationSettingsTagHelper Rotation { get; set; }
