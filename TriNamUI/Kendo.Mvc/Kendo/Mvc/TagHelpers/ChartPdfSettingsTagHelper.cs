...
// Type: Kendo.Mvc.TagHelpers.ChartPdfSettingsTagHelper
...
{
  [HtmlTargetElement("pdf", ParentTag = "kendo-chart", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-pdf-margin", new string[] {})]
  [SuppressTagRendering]
  public class ChartPdfSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartTagHelper).Pdf = this;
    }
    ...
    public ChartPdfMarginSettingsTagHelper Margin { get; set; }
