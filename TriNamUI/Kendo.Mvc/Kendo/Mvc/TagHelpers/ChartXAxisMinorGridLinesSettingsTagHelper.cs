...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisMinorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("minor-grid-lines", ParentTag = "x-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartXAxisMinorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisTagHelper).MinorGridLines = this;
    }
