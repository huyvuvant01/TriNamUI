...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesOutliersSettingsTagHelper
...
{
  [HtmlTargetElement("outliers", ParentTag = "series-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {})]
  [SuppressTagRendering]
  public class ChartSeriesOutliersSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesTagHelper).Outliers = this;
    }
    ...
    public ChartSeriesOutliersBorderSettingsTagHelper Border { get; set; }
