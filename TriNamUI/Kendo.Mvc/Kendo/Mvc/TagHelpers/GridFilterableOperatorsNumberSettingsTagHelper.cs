...
// Type: Kendo.Mvc.TagHelpers.GridFilterableOperatorsNumberSettingsTagHelper
...
{
  [HtmlTargetElement("number", ParentTag = "operators", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class GridFilterableOperatorsNumberSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as GridFilterableOperatorsSettingsTagHelper).Number = this;
    }
