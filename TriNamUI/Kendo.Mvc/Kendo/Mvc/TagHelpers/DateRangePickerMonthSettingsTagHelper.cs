...
// Type: Kendo.Mvc.TagHelpers.DateRangePickerMonthSettingsTagHelper
...
{
  [HtmlTargetElement("month", ParentTag = "kendo-daterangepicker", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class DateRangePickerMonthSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as DateRangePickerTagHelper).Month = this;
    }
