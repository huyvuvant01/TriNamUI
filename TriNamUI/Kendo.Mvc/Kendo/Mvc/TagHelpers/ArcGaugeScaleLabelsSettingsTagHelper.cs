...
// Type: Kendo.Mvc.TagHelpers.ArcGaugeScaleLabelsSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class ArcGaugeScaleLabelsSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ArcGaugeScaleSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ArcGaugeScaleSettingsTagHelper).Labels = this;
    }
    ...
    public ArcGaugeScaleLabelsBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ArcGaugeScaleLabelsMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ArcGaugeScaleLabelsPaddingSettingsTagHelper Padding { get; set; }
