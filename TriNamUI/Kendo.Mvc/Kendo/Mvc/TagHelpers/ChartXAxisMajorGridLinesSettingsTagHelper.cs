...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisMajorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("major-grid-lines", ParentTag = "x-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartXAxisMajorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisTagHelper).MajorGridLines = this;
    }
