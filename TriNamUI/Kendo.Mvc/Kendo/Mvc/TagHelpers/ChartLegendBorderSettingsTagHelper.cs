...
// Type: Kendo.Mvc.TagHelpers.ChartLegendBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "chart-legend", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartLegendBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartLegendSettingsTagHelper).Border = this;
    }
