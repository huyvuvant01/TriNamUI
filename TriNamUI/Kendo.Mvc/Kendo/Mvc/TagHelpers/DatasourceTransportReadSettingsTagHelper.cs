...
// Type: Kendo.Mvc.TagHelpers.DatasourceTransportReadSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class DatasourceTransportReadSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as DataSourceTransportSettingsTagHelper).Read = this;
    }
    ...
    internal Dictionary<string, object> Serialize()
    {
      ...
      string url = this.Url;
      int num = url != null ? (url.HasValue() ? 1 : 0) : 0;
      dictionary["url"] = num == 0 ? (object) string.Empty : (object) this.Url;
