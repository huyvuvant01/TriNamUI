...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisLabelsBorderSettingsTagHelper
...
{
  [HtmlTargetElement("chart-value-axis-labels-border", ParentTag = "labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartValueAxisLabelsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisLabelsSettingsTagHelper).Border = this;
    }
