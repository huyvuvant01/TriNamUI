...
// Type: Kendo.Mvc.TagHelpers.FileManagerToolbarSettingsTagHelper
...
{
  [HtmlTargetElement("toolbar", ParentTag = "kendo-filemanager", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("items", new string[] {})]
  [SuppressTagRendering]
  public class FileManagerToolbarSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FileManagerTagHelper).Toolbar = this;
    }
    ...
    public FileManagerToolbarSettingsItemsTagHelper Items { get; set; }
    ...
    internal Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.Items != null)
      {
        IEnumerable<Dictionary<string, object>> source = this.Items.Select<FileManagerToolbarSettingsItemTagHelper, Dictionary<string, object>>((Func<FileManagerToolbarSettingsItemTagHelper, Dictionary<string, object>>) (i => i.Serialize()));
