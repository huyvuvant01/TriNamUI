...
// Type: Kendo.Mvc.TagHelpers.MapStyleStrokeSettingsTagHelper
...
{
  [HtmlTargetElement("stroke", ParentTag = "map-style", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class MapStyleStrokeSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    {
      Type type = typeof (MapStyleSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as MapStyleSettingsTagHelper).Stroke = this;
    }
