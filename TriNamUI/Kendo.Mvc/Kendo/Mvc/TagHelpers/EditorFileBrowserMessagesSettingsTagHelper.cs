...
// Type: Kendo.Mvc.TagHelpers.EditorFileBrowserMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "file-browser", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class EditorFileBrowserMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorFileBrowserSettingsTagHelper).Messages = this;
    }
