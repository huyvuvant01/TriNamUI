...
// Type: Kendo.Mvc.TagHelpers.ArcGaugeScaleLabelsBorderSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class ArcGaugeScaleLabelsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ArcGaugeScaleLabelsSettingsTagHelper).Border = this;
    }
