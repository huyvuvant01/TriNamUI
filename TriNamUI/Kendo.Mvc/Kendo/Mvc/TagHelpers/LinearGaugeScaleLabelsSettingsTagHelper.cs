...
// Type: Kendo.Mvc.TagHelpers.LinearGaugeScaleLabelsSettingsTagHelper
...
{
  [HtmlTargetElement("lineargauge-scale-labels", ParentTag = "scale", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class LinearGaugeScaleLabelsSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (LinearGaugeScaleSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as LinearGaugeScaleSettingsTagHelper).Labels = this;
    }
    ...
    public LinearGaugeScaleLabelsBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public LinearGaugeScaleLabelsMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public LinearGaugeScaleLabelsPaddingSettingsTagHelper Padding { get; set; }
