...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisLabelsDateFormatsSettingsTagHelper
...
{
  [HtmlTargetElement("chart-x-axis-labels-date-formats", ParentTag = "labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartXAxisLabelsDateFormatsSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartXAxisLabelsSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisLabelsSettingsTagHelper).DateFormats = this;
    }
