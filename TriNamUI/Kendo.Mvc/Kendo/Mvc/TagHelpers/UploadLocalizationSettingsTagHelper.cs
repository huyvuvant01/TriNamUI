...
// Type: Kendo.Mvc.TagHelpers.UploadLocalizationSettingsTagHelper
...
{
  [HtmlTargetElement("localization", ParentTag = "kendo-upload", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class UploadLocalizationSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as UploadTagHelper).Localization = this;
    }
    ...
    internal Dictionary<string, object> SerializeSettings()
    {
      ...
      string headerStatusPaused = this.HeaderStatusPaused;
      if ((headerStatusPaused != null ? (headerStatusPaused.HasValue() ? 1 : 0) : 0) != 0)
      ...
      string uploadSuccess = this.UploadSuccess;
      if ((uploadSuccess != null ? (uploadSuccess.HasValue() ? 1 : 0) : 0) != 0)
        dictionary["uploadSuccess"] = (object) this.UploadSuccess;
      string uploadFail = this.UploadFail;
      if ((uploadFail != null ? (uploadFail.HasValue() ? 1 : 0) : 0) != 0)
