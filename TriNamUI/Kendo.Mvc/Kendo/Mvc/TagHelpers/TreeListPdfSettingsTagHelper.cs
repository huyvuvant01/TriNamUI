...
// Type: Kendo.Mvc.TagHelpers.TreeListPdfSettingsTagHelper
...
{
  [HtmlTargetElement("pdf", ParentTag = "kendo-treelist", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("treelist-pdf-margin", new string[] {})]
  [SuppressTagRendering]
  public class TreeListPdfSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TreeListTagHelper).Pdf = this;
    }
    ...
    public TreeListPdfMarginSettingsTagHelper Margin { get; set; }
