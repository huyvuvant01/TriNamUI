...
// Type: Kendo.Mvc.TagHelpers.TaskBoardToolbarSettingsItemTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class TaskBoardToolbarSettingsItemTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      System.Type type = typeof (TaskBoardToolbarSettingsItemsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TaskBoardToolbarSettingsItemsTagHelper).Add(this);
    }
