...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisMajorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("major-grid-lines", ParentTag = "value-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartValueAxisMajorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      System.Type type = typeof (ChartValueAxisTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisTagHelper).MajorGridLines = this;
    }
