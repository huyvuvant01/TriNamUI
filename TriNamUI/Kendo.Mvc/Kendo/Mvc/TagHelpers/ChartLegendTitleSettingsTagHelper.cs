...
// Type: Kendo.Mvc.TagHelpers.ChartLegendTitleSettingsTagHelper
...
{
  [HtmlTargetElement("title", ParentTag = "legend", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartLegendTitleSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartLegendSettingsTagHelper).Title = this;
    }
    ...
    public ChartLegendTitleBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartLegendTitleMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartLegendTitlePaddingSettingsTagHelper Padding { get; set; }
