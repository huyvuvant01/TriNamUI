...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesOutliersBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "outliers", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesOutliersBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesOutliersSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesOutliersSettingsTagHelper).Border = this;
    }
