...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesNotesLabelSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-notes-label", ParentTag = "notes", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {})]
  [SuppressTagRendering]
  public class ChartSeriesNotesLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesNotesSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesNotesSettingsTagHelper).Label = this;
    }
    ...
    public ChartSeriesNotesLabelBorderSettingsTagHelper Border { get; set; }
