...
// Type: Kendo.Mvc.TagHelpers.ComboBoxTagHelper
...
{
  [HtmlTargetElement("kendo-combobox")]
  [HtmlTargetElement("combobox-editor", ParentTag = "form-item")]
  [RestrictChildren("popup-animation", new string[] {"popup", "virtual", "datasource", "messages"})]
  [OutputElementHint("div")]
  public class ComboBoxTagHelper : DropDownBaseTagHelper, IKendoFormEditor
  {
    private static readonly 
    #nullable disable
    Regex EscapeRegex = new Regex("([;&,\\.\\+\\*~'\\:\\\"\\!\\^\\$\\[\\]\\(\\)\\|\\/])", RegexOptions.Compiled);

    public ComboBoxTagHelper(IKendoHtmlGenerator generator)
      : base(generator)
    {
    }
    ...
    {
      ComboBoxTagHelper comboBoxTagHelper = this;
    ...
    protected override string GetInitializationScript()
    {
      if (!this.DatasourceId.HasValue() && this.Datasource != null)
      {
        ...
        if (serverFiltering.GetValueOrDefault() == flag & serverFiltering.HasValue && this.Datasource.Transport != null && this.Datasource.Transport.Read != null && !this.Datasource.Transport.Read.Data.HasValue())
          this.Datasource.Transport.Read.Data = "function() { return kendo.ui.ComboBox.requestData(jQuery(\"" + ComboBoxTagHelper.EscapeRegex.Replace(this.Selector, "\\\\$1") + "\")); }";
      }
      return this.Initializer.Initialize(this.Selector, "ComboBox", (IDictionary<string, object>) this.Serialize());
    }
    ...
    public bool TryAddToForm(TagHelperContext context)
    {
      foreach (KeyValuePair<object, object> keyValuePair in context.Items.Reverse<KeyValuePair<object, object>>())
      {
        if (keyValuePair.Value is FormItemTagHelper formItemTagHelper1)
        {
          ...
          formItemTagHelper1.Editor = "ComboBox";
          return true;
        }
      }
      return false;
    ...
    [HtmlAttributeNotBound]
    public ComboBoxMessagesSettingsTagHelper Messages { get; set; }
