...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesMarkersFromBorderSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-markers-from-border", ParentTag = "from", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesMarkersFromBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesMarkersFromSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesMarkersFromSettingsTagHelper).Border = this;
    }
