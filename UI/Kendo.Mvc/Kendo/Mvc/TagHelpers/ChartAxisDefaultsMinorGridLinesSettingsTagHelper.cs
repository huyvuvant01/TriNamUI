...
// Type: Kendo.Mvc.TagHelpers.ChartAxisDefaultsMinorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("minor-grid-lines", ParentTag = "axis-defaults", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartAxisDefaultsMinorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartAxisDefaultsSettingsTagHelper).MinorGridLines = this;
    }
