...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisPlotBandLabelBorderSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class ChartYAxisPlotBandLabelBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisPlotBandLabelSettingsTagHelper).Border = this;
    }
