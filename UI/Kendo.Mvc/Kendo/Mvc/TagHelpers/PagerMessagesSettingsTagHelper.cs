...
// Type: Kendo.Mvc.TagHelpers.PagerMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "kendo-pager", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class PagerMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (PagerTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as PagerTagHelper).Messages = this;
    }
