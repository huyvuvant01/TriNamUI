...
// Type: Kendo.Mvc.TagHelpers.TaskBoardPreviewPaneSettingsButtonTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class TaskBoardPreviewPaneSettingsButtonTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      Type type = typeof (TaskBoardPreviewPaneSettingsButtonsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TaskBoardPreviewPaneSettingsButtonsTagHelper).Add(this);
    }
