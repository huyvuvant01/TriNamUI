...
// Type: Kendo.Mvc.TagHelpers.ImageEditorToolbarSettingsItemTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class ImageEditorToolbarSettingsItemTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      System.Type type = typeof (ImageEditorToolbarSettingsItemsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ImageEditorToolbarSettingsItemsTagHelper).Add(this);
    }
