...
// Type: Kendo.Mvc.TagHelpers.ChartAxisDefaultsCrosshairSettingsTagHelper
...
{
  [HtmlTargetElement("crosshair", ParentTag = "axis-defaults", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-axis-defaults-crosshair-tooltip", new string[] {})]
  [SuppressTagRendering]
  public class ChartAxisDefaultsCrosshairSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartAxisDefaultsSettingsTagHelper).Crosshair = this;
    }
    ...
    public ChartAxisDefaultsCrosshairTooltipSettingsTagHelper Tooltip { get; set; }
