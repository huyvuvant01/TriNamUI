...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisCrosshairSettingsTagHelper
...
{
  [HtmlTargetElement("crosshair", ParentTag = "value-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-value-axis-crosshair-tooltip", new string[] {})]
  [SuppressTagRendering]
  public class ChartValueAxisCrosshairSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisTagHelper).Crosshair = this;
    }
    ...
    public ChartValueAxisCrosshairTooltipSettingsTagHelper Tooltip { get; set; }
