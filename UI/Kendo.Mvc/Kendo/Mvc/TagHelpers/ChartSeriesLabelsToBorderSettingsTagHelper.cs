...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesLabelsToBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "chart-series-labels-to", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesLabelsToBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesLabelsToSettingsTagHelper).Border = this;
    }
