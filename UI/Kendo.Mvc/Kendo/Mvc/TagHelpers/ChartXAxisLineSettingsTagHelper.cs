...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisLineSettingsTagHelper
...
{
  [HtmlTargetElement("line", ParentTag = "x-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartXAxisLineSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisTagHelper).Line = this;
    }
