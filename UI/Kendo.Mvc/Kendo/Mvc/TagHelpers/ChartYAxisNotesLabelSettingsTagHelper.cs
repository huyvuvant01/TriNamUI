...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisNotesLabelSettingsTagHelper
...
{
  [HtmlTargetElement("chart-y-axis-notes-label", ParentTag = "notes", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {})]
  [SuppressTagRendering]
  public class ChartYAxisNotesLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisNotesSettingsTagHelper).Label = this;
    }
    ...
    public ChartYAxisNotesLabelBorderSettingsTagHelper Border { get; set; }
