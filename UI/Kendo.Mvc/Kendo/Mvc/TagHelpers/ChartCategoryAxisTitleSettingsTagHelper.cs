...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisTitleSettingsTagHelper
...
{
  [HtmlTargetElement("chart-category-axis-item-title", ParentTag = "category-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartCategoryAxisTitleSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisTagHelper).Title = this;
    }
    ...
    public ChartCategoryAxisTitleBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartCategoryAxisTitleMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartCategoryAxisTitlePaddingSettingsTagHelper Padding { get; set; }
