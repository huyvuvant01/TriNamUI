...
// Type: Kendo.Mvc.TagHelpers.EditorFileBrowserTransportCreateSettingsTagHelper
...
{
  [HtmlTargetElement("create", ParentTag = "file-browser-transport", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class EditorFileBrowserTransportCreateSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorFileBrowserTransportSettingsTagHelper).Create = this;
    }
