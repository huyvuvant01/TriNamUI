...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisCrosshairTooltipSettingsTagHelper
...
{
  [HtmlTargetElement("chart-x-axis-crosshair-tooltip", ParentTag = "crosshair", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"padding"})]
  [SuppressTagRendering]
  public class ChartXAxisCrosshairTooltipSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartXAxisCrosshairSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisCrosshairSettingsTagHelper).Tooltip = this;
    }
    ...
    public ChartXAxisCrosshairTooltipBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartXAxisCrosshairTooltipPaddingSettingsTagHelper Padding { get; set; }
