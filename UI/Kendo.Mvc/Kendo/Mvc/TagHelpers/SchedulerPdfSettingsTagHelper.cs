...
// Type: Kendo.Mvc.TagHelpers.SchedulerPdfSettingsTagHelper
...
{
  [HtmlTargetElement("pdf", ParentTag = "kendo-scheduler", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("scheduler-pdf-margin", new string[] {})]
  [SuppressTagRendering]
  public class SchedulerPdfSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as SchedulerTagHelper).Pdf = this;
    }
    ...
    public SchedulerPdfMarginSettingsTagHelper Margin { get; set; }
