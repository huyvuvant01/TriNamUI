...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisLabelsSettingsTagHelper
...
{
  [HtmlTargetElement("labels", ParentTag = "category-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-category-axis-labels-border", new string[] {"chart-category-axis-labels-date-formats", "chart-category-axis-labels-margin", "chart-category-axis-labels-padding", "chart-category-axis-labels-rotation"})]
  [SuppressTagRendering]
  public class ChartCategoryAxisLabelsSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisTagHelper).Labels = this;
    }
    ...
    public ChartCategoryAxisLabelsBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartCategoryAxisLabelsDateFormatsSettingsTagHelper DateFormats { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartCategoryAxisLabelsMarginSettingsTagHelper Margin { get; set; }

    public bool? Mirror { get; set; }

    [HtmlAttributeNotBound]
    public ChartCategoryAxisLabelsPaddingSettingsTagHelper Padding { get; set; }

    [HtmlAttributeNotBound]
    public ChartCategoryAxisLabelsRotationSettingsTagHelper Rotation { get; set; }
