...
// Type: Kendo.Mvc.TagHelpers.MapControlsNavigatorSettingsTagHelper
...
{
  [HtmlTargetElement("navigator", ParentTag = "controls", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class MapControlsNavigatorSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as MapControlsSettingsTagHelper).Navigator = this;
    }
