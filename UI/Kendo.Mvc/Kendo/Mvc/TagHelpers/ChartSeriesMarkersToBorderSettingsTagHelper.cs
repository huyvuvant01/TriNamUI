...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesMarkersToBorderSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-markers-to-border", ParentTag = "to", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesMarkersToBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesMarkersToSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesMarkersToSettingsTagHelper).Border = this;
    }
