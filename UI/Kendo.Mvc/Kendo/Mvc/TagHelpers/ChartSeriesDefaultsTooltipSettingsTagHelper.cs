...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesDefaultsTooltipSettingsTagHelper
...
{
  [HtmlTargetElement("tooltip", ParentTag = "series-defaults", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-series-defaults-tooltip-border", new string[] {"chart-series-defaults-tooltip-padding"})]
  [SuppressTagRendering]
  public class ChartSeriesDefaultsTooltipSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesDefaultsSettingsTagHelper).Tooltip = this;
    }
    ...
    public ChartSeriesDefaultsTooltipBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartSeriesDefaultsTooltipPaddingSettingsTagHelper Padding { get; set; }
