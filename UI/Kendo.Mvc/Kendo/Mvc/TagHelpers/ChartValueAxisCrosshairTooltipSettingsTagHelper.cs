...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisCrosshairTooltipSettingsTagHelper
...
{
  [HtmlTargetElement("chart-value-axis-crosshair-tooltip", ParentTag = "crosshair", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"padding"})]
  [SuppressTagRendering]
  public class ChartValueAxisCrosshairTooltipSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartValueAxisCrosshairSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisCrosshairSettingsTagHelper).Tooltip = this;
    }
    ...
    public ChartValueAxisCrosshairTooltipBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartValueAxisCrosshairTooltipPaddingSettingsTagHelper Padding { get; set; }
