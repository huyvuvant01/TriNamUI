...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisMajorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("major-grid-lines", ParentTag = "y-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartYAxisMajorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisTagHelper).MajorGridLines = this;
    }
