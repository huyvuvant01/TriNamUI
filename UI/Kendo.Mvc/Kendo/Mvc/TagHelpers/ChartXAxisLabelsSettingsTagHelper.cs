...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisLabelsSettingsTagHelper
...
{
  [HtmlTargetElement("labels", ParentTag = "x-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-x-axis-labels-border", new string[] {"chart-x-axis-labels-date-formats", "chart-x-axis-labels-margin", "chart-x-axis-labels-padding", "chart-x-axis-labels-rotation"})]
  [SuppressTagRendering]
  public class ChartXAxisLabelsSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    {
      Type type = typeof (ChartXAxisTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisTagHelper).Labels = this;
    }
    ...
    public ChartXAxisLabelsBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartXAxisLabelsDateFormatsSettingsTagHelper DateFormats { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartXAxisLabelsMarginSettingsTagHelper Margin { get; set; }

    public bool? Mirror { get; set; }

    [HtmlAttributeNotBound]
    public ChartXAxisLabelsPaddingSettingsTagHelper Padding { get; set; }

    [HtmlAttributeNotBound]
    public ChartXAxisLabelsRotationSettingsTagHelper Rotation { get; set; }
