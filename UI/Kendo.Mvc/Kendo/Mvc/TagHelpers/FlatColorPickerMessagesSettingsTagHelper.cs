...
// Type: Kendo.Mvc.TagHelpers.FlatColorPickerMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "kendo-flatcolorpicker", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class FlatColorPickerMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FlatColorPickerTagHelper).Messages = this;
    }
