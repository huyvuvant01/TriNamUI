...
// Type: Kendo.Mvc.TagHelpers.TreeViewCheckboxesSettingsTagHelper
...
{
  [HtmlTargetElement("checkboxes", ParentTag = "kendo-treeview", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class TreeViewCheckboxesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TreeViewTagHelper).Checkboxes = this;
    }
