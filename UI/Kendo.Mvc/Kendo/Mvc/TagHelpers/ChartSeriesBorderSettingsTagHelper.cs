...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "series-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesTagHelper).Border = this;
    }
    ...
    public string OpacityHandler { get; set; }
    ...
    internal Dictionary<string, object> SerializeSettings()
    {
      ...
      string opacityHandler = this.OpacityHandler;
      double? nullable;
      if ((opacityHandler != null ? (opacityHandler.HasValue() ? 1 : 0) : 0) != 0)
      {
        dictionary1["opacity"] = (object) this.CreateHandler(this.OpacityHandler);
      }
      else
      {
