...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisNotesLineSettingsTagHelper
...
{
  [HtmlTargetElement("chart-value-axis-notes-line", ParentTag = "notes", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartValueAxisNotesLineSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisNotesSettingsTagHelper).Line = this;
    }
