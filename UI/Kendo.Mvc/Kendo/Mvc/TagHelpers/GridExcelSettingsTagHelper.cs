...
// Type: Kendo.Mvc.TagHelpers.GridExcelSettingsTagHelper
...
{
  [HtmlTargetElement("excel", ParentTag = "kendo-grid", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class GridExcelSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as GridTagHelper).Excel = this;
    }
