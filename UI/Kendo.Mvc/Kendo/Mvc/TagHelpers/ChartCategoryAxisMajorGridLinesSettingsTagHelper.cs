...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisMajorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("major-grid-lines", ParentTag = "category-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartCategoryAxisMajorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisTagHelper).MajorGridLines = this;
    }
