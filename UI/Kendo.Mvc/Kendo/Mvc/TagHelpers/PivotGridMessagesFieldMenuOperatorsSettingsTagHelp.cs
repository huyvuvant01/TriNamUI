...
// Type: Kendo.Mvc.TagHelpers.PivotGridMessagesFieldMenuOperatorsSettingsTagHelper
...
{
  [HtmlTargetElement("operators", ParentTag = "pivotgrid-messages-field-menu", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class PivotGridMessagesFieldMenuOperatorsSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (PivotGridMessagesFieldMenuSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as PivotGridMessagesFieldMenuSettingsTagHelper).Operators = this;
    }
