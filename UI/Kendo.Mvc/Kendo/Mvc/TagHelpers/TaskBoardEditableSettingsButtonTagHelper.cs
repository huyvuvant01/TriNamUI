...
// Type: Kendo.Mvc.TagHelpers.TaskBoardEditableSettingsButtonTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class TaskBoardEditableSettingsButtonTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      Type type = typeof (TaskBoardEditableSettingsButtonsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TaskBoardEditableSettingsButtonsTagHelper).Add(this);
    }
