...
// Type: Kendo.Mvc.TagHelpers.EditorImageBrowserTransportReadSettingsTagHelper
...
{
  [HtmlTargetElement("read", ParentTag = "image-browser-transport", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class EditorImageBrowserTransportReadSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorImageBrowserTransportSettingsTagHelper).Read = this;
    }
