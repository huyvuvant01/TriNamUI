...
// Type: Kendo.Mvc.TagHelpers.OrgChartMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "kendo-orgchart", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class OrgChartMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as OrgChartTagHelper).Messages = this;
    }
