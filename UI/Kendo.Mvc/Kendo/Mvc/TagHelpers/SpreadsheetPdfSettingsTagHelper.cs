...
// Type: Kendo.Mvc.TagHelpers.SpreadsheetPdfSettingsTagHelper
...
{
  [HtmlTargetElement("pdf", ParentTag = "kendo-spreadsheet", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("margin", new string[] {})]
  [SuppressTagRendering]
  public class SpreadsheetPdfSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as SpreadsheetTagHelper).Pdf = this;
    }
    ...
    public SpreadsheetPdfMarginSettingsTagHelper Margin { get; set; }
