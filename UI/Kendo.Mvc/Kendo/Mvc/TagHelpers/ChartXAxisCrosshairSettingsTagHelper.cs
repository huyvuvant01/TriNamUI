...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisCrosshairSettingsTagHelper
...
{
  [HtmlTargetElement("crosshair", ParentTag = "x-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-x-axis-crosshair-tooltip", new string[] {})]
  [SuppressTagRendering]
  public class ChartXAxisCrosshairSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisTagHelper).Crosshair = this;
    }
    ...
    public ChartXAxisCrosshairTooltipSettingsTagHelper Tooltip { get; set; }
