...
// Type: Kendo.Mvc.TagHelpers.MapMarkerDefaultsSettingsTagHelper
...
{
  [HtmlTargetElement("marker-defaults", ParentTag = "kendo-map", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("tooltip", new string[] {})]
  [SuppressTagRendering]
  public class MapMarkerDefaultsSettingsTagHelper : 
    TagHelperChildBase,
    IMapToolTipParent<
    #nullable disable
    MapTooltipTagHelper>
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as MapTagHelper).MarkerDefaults = this;
    }
