...
// Type: Kendo.Mvc.TagHelpers.EditorPdfSettingsTagHelper
...
{
  [HtmlTargetElement("pdf", ParentTag = "kendo-editor", TagStructure = TagStructure.NormalOrSelfClosing)]
  [HtmlTargetElement("pdf", ParentTag = "richtexteditor-editor", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("margin", new string[] {})]
  [SuppressTagRendering]
  public class EditorPdfSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorTagHelper).Pdf = this;
    }
    ...
    public EditorPdfMarginSettingsTagHelper Margin { get; set; }
