...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisMinorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("minor-grid-lines", ParentTag = "y-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartYAxisMinorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisTagHelper).MinorGridLines = this;
    }
