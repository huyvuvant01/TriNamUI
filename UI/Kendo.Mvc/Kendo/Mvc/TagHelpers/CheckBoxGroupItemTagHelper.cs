...
// Type: Kendo.Mvc.TagHelpers.CheckBoxGroupItemTagHelper
...
{
  [HtmlTargetElement("kendo-checkboxgroup-item", ParentTag = "kendo-checkboxgroup-items", TagStructure = TagStructure.NormalOrSelfClosing)]
  [SuppressTagRendering]
  public class CheckBoxGroupItemTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      Type type = typeof (CheckBoxGroupItemsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as CheckBoxGroupItemsTagHelper).Add(this);
    }
