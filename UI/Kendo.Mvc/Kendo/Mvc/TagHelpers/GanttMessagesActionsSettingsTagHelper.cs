...
// Type: Kendo.Mvc.TagHelpers.GanttMessagesActionsSettingsTagHelper
...
{
  [HtmlTargetElement("actions", ParentTag = "messages", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class GanttMessagesActionsSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as GanttMessagesSettingsTagHelper).Actions = this;
    }
