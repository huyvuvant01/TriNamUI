...
// Type: Kendo.Mvc.TagHelpers.ColorPickerMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "kendo-colorpicker", TagStructure = TagStructure.WithoutEndTag)]
  [HtmlTargetElement("messages", ParentTag = "colorpicker-editor", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ColorPickerMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ColorPickerTagHelper).Messages = this;
    }
