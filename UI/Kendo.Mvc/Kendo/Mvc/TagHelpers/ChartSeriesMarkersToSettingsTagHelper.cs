...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesMarkersToSettingsTagHelper
...
{
  [HtmlTargetElement("to", ParentTag = "markers", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("chart-series-markers-to-border", new string[] {})]
  [SuppressTagRendering]
  public class ChartSeriesMarkersToSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesMarkersSettingsTagHelper).To = this;
    }
    ...
    public ChartSeriesMarkersToBorderSettingsTagHelper Border { get; set; }
