...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisLineSettingsTagHelper
...
{
  [HtmlTargetElement("line", ParentTag = "y-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartYAxisLineSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisTagHelper).Line = this;
    }
