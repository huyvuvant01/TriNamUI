...
// Type: Kendo.Mvc.TagHelpers.SchedulerMessagesRecurrenceEditorWeeklySettingsTagHelper
...
{
  [HtmlTargetElement("weekly", ParentTag = "recurrence-editor", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class SchedulerMessagesRecurrenceEditorWeeklySettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as SchedulerMessagesRecurrenceEditorSettingsTagHelper).Weekly = this;
    }
