...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisLabelsBorderSettingsTagHelper
...
{
  [HtmlTargetElement("chart-y-axis-labels-border", ParentTag = "labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartYAxisLabelsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisLabelsSettingsTagHelper).Border = this;
    }
