...
// Type: Kendo.Mvc.TagHelpers.FileManagerMessagesDialogsMoveConfirmSettingsTagHelper
...
{
  [HtmlTargetElement("move-confirm", ParentTag = "dialogs", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class FileManagerMessagesDialogsMoveConfirmSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FileManagerMessagesDialogsSettingsTagHelper).MoveConfirm = this;
    }
