...
// Type: Kendo.Mvc.TagHelpers.TaskBoardCardMenuTagHelper
...
{
  [HtmlTargetElement("item", ParentTag = "card-menu", TagStructure = TagStructure.NormalOrSelfClosing)]
  [SuppressTagRendering]
  public class TaskBoardCardMenuTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      Type type = typeof (TaskBoardCardMenusTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as TaskBoardCardMenusTagHelper).Add(this);
    }
