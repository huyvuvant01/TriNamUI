...
// Type: Kendo.Mvc.TagHelpers.ChartZoomableSelectionSettingsTagHelper
...
{
  [HtmlTargetElement("selection", ParentTag = "zoomable", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartZoomableSelectionSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartZoomableSettingsTagHelper).Selection = this;
    }
