...
// Type: Kendo.Mvc.TagHelpers.GridFilterableOperatorsStringSettingsTagHelper
...
{
  [HtmlTargetElement("string", ParentTag = "operators", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class GridFilterableOperatorsStringSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as GridFilterableOperatorsSettingsTagHelper).String = this;
    }
