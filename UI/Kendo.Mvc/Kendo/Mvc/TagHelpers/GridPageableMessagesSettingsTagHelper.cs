...
// Type: Kendo.Mvc.TagHelpers.GridPageableMessagesSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class GridPageableMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (GridPageableSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as GridPageableSettingsTagHelper).Messages = this;
    }
