...
// Type: Kendo.Mvc.TagHelpers.EditorFileBrowserTransportReadSettingsTagHelper
...
{
  [HtmlTargetElement("read", ParentTag = "file-browser-transport", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class EditorFileBrowserTransportReadSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorFileBrowserTransportSettingsTagHelper).Read = this;
    }
