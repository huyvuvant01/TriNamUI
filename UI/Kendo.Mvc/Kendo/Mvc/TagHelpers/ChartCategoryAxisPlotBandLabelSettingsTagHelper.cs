...
// Type: Kendo.Mvc.TagHelpers.ChartCategoryAxisPlotBandLabelSettingsTagHelper
...
{
  [HtmlTargetElement("label", ParentTag = "chart-category-axis-plot-bands", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartCategoryAxisPlotBandLabelSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartCategoryAxisPlotBandTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartCategoryAxisPlotBandTagHelper).Label = this;
    }
    ...
    public ChartCategoryAxisPlotBandLabelBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartCategoryAxisPlotBandLabelMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartCategoryAxisPlotBandLabelPaddingSettingsTagHelper Padding { get; set; }
