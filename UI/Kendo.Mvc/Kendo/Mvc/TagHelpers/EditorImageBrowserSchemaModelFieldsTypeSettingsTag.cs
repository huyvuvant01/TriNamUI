...
// Type: Kendo.Mvc.TagHelpers.EditorImageBrowserSchemaModelFieldsTypeSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class EditorImageBrowserSchemaModelFieldsTypeSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorImageBrowserSchemaModelFieldsSettingsTagHelper).Type = this;
    }
