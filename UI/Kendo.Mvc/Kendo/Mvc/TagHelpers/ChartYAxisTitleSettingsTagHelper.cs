...
// Type: Kendo.Mvc.TagHelpers.ChartYAxisTitleSettingsTagHelper
...
{
  [HtmlTargetElement("chart-y-axis-item-title", ParentTag = "y-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartYAxisTitleSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartYAxisTagHelper).Title = this;
    }
    ...
    public ChartYAxisTitleBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartYAxisTitleMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartYAxisTitlePaddingSettingsTagHelper Padding { get; set; }
