...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisMinorGridLinesSettingsTagHelper
...
{
  [HtmlTargetElement("minor-grid-lines", ParentTag = "value-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartValueAxisMinorGridLinesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisTagHelper).MinorGridLines = this;
    }
