...
// Type: Kendo.Mvc.TagHelpers.ChartXAxisPlotBandLabelPaddingSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class ChartXAxisPlotBandLabelPaddingSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartXAxisPlotBandLabelSettingsTagHelper).Padding = this;
    }
