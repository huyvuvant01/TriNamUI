...
// Type: Kendo.Mvc.TagHelpers.EditorFileBrowserSchemaModelFieldsNameSettingsTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class EditorFileBrowserSchemaModelFieldsNameSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorFileBrowserSchemaModelFieldsSettingsTagHelper).Name = this;
    }
