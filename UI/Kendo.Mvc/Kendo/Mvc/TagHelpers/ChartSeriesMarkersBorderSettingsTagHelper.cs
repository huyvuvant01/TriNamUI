...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesMarkersBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "markers", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartSeriesMarkersBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesMarkersSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesMarkersSettingsTagHelper).Border = this;
    }
