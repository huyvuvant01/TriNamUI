...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisLineSettingsTagHelper
...
{
  [HtmlTargetElement("line", ParentTag = "value-axis-item", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartValueAxisLineSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisTagHelper).Line = this;
    }
