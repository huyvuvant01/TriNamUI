...
// Type: Kendo.Mvc.TagHelpers.DataSourceTransportCreateSettingsTagHelper
...
{
  [HtmlTargetElement("create", ParentTag = "transport", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class DataSourceTransportCreateSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as DataSourceTransportSettingsTagHelper).Create = this;
    }
