...
// Type: Kendo.Mvc.TagHelpers.ChartPaneTitleSettingsTagHelper
...
{
  [HtmlTargetElement("chart-pane-title", ParentTag = "pane", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin"})]
  [SuppressTagRendering]
  public class ChartPaneTitleSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    {
      Type type = typeof (ChartPaneTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartPaneTagHelper).Title = this;
    }
    ...
    public ChartPaneTitleBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartPaneTitleMarginSettingsTagHelper Margin { get; set; }
