...
// Type: Kendo.Mvc.TagHelpers.ChartAxisDefaultsLineSettingsTagHelper
...
{
  [HtmlTargetElement("line", ParentTag = "axis-defaults", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class ChartAxisDefaultsLineSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartAxisDefaultsSettingsTagHelper).Line = this;
    }
