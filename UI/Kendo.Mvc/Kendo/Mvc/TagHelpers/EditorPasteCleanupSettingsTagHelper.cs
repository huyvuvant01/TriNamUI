...
// Type: Kendo.Mvc.TagHelpers.EditorPasteCleanupSettingsTagHelper
...
{
  [HtmlTargetElement("paste-cleanup", ParentTag = "kendo-editor", TagStructure = TagStructure.WithoutEndTag)]
  [HtmlTargetElement("paste-cleanup", ParentTag = "richtexteditor-editor", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class EditorPasteCleanupSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as EditorTagHelper).PasteCleanup = this;
    }
