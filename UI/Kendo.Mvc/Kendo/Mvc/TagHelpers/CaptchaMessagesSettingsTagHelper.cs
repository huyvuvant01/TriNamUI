...
// Type: Kendo.Mvc.TagHelpers.CaptchaMessagesSettingsTagHelper
...
{
  [HtmlTargetElement("messages", ParentTag = "kendo-captcha", TagStructure = TagStructure.WithoutEndTag)]
  [HtmlTargetElement("messages", ParentTag = "captcha-editor", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class CaptchaMessagesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as CaptchaTagHelper).Messages = this;
    }
