...
// Type: Kendo.Mvc.TagHelpers.FileManagerToolbarSettingsItemTagHelper
...
namespace Kendo.Mvc.TagHelpers
{
  ...
  public class FileManagerToolbarSettingsItemTagHelper : TagHelperCollectionItemBase
  {
    ...
    {
      System.Type type = typeof (FileManagerToolbarSettingsItemsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FileManagerToolbarSettingsItemsTagHelper).Add(this);
    }
