...
// Type: Kendo.Mvc.TagHelpers.FilterOperatorsNumberSettingsTagHelper
...
{
  [HtmlTargetElement("filter-operators-number", ParentTag = "operators")]
  [SuppressTagRendering]
  public class FilterOperatorsNumberSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as FilterOperatorsSettingsTagHelper).Number = this;
    }
