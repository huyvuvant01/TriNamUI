...
// Type: Kendo.Mvc.TagHelpers.ChartSeriesDefaultsLabelsFromSettingsTagHelper
...
{
  [HtmlTargetElement("chart-series-defaults-labels-from", ParentTag = "labels", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartSeriesDefaultsLabelsFromSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (ChartSeriesDefaultsLabelsSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartSeriesDefaultsLabelsSettingsTagHelper).From = this;
    }
    ...
    public ChartSeriesDefaultsLabelsFromBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartSeriesDefaultsLabelsFromMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartSeriesDefaultsLabelsFromPaddingSettingsTagHelper Padding { get; set; }
