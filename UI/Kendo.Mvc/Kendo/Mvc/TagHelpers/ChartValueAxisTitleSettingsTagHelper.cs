...
// Type: Kendo.Mvc.TagHelpers.ChartValueAxisTitleSettingsTagHelper
...
{
  [HtmlTargetElement("chart-value-axis-item-title", ParentTag = "value-axis-item", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class ChartValueAxisTitleSettingsTagHelper : TagHelperChildBase
  {
    public 
    #nullable disable
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as ChartValueAxisTagHelper).Title = this;
    }
    ...
    public ChartValueAxisTitleBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public ChartValueAxisTitleMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public ChartValueAxisTitlePaddingSettingsTagHelper Padding { get; set; }
