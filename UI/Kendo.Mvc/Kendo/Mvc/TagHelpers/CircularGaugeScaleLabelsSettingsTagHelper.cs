...
// Type: Kendo.Mvc.TagHelpers.CircularGaugeScaleLabelsSettingsTagHelper
...
{
  [HtmlTargetElement("labels", ParentTag = "scale", TagStructure = TagStructure.NormalOrSelfClosing)]
  [RestrictChildren("border", new string[] {"margin", "padding"})]
  [SuppressTagRendering]
  public class CircularGaugeScaleLabelsSettingsTagHelper : TagHelperChildBase
  {
    ...
    {
      Type type = typeof (CircularGaugeScaleSettingsTagHelper);
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as CircularGaugeScaleSettingsTagHelper).Labels = this;
    }
    ...
    public CircularGaugeScaleLabelsBorderSettingsTagHelper Border { get; set; }
    ...
    [HtmlAttributeNotBound]
    public CircularGaugeScaleLabelsMarginSettingsTagHelper Margin { get; set; }

    [HtmlAttributeNotBound]
    public CircularGaugeScaleLabelsPaddingSettingsTagHelper Padding { get; set; }
