...
// Type: Kendo.Mvc.TagHelpers.LinearGaugeScaleLabelsBorderSettingsTagHelper
...
{
  [HtmlTargetElement("border", ParentTag = "lineargauge-scale-labels", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class LinearGaugeScaleLabelsBorderSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as LinearGaugeScaleLabelsSettingsTagHelper).Border = this;
    }
