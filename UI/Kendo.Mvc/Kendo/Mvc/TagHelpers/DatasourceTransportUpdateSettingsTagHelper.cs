...
// Type: Kendo.Mvc.TagHelpers.DatasourceTransportUpdateSettingsTagHelper
...
{
  [HtmlTargetElement("update", ParentTag = "transport", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class DatasourceTransportUpdateSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as DataSourceTransportSettingsTagHelper).Update = this;
    }
