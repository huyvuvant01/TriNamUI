...
// Type: Kendo.Mvc.TagHelpers.SchedulerMessagesRecurrenceEditorFrequenciesSettingsTagHelper
...
{
  [HtmlTargetElement("frequencies", ParentTag = "recurrence-editor", TagStructure = TagStructure.WithoutEndTag)]
  [SuppressTagRendering]
  public class SchedulerMessagesRecurrenceEditorFrequenciesSettingsTagHelper : TagHelperChildBase
  {
    ...
    protected override void AddSelfToParent(TagHelperContext context)
    {
      ...
      if (!context.Items.ContainsKey((object) type))
        return;
      (context.Items[(object) type] as SchedulerMessagesRecurrenceEditorSettingsTagHelper).Frequencies = this;
    }
