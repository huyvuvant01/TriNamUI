...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisLabelsMarginSettings`1
...
{
  public class StockChartNavigatorCategoryAxisLabelsMarginSettings<T> where T : class
  {
