...
// Type: Kendo.Mvc.UI.ButtonBadgeSettings
...
{
  public class ButtonBadgeSettings
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.TemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.Button.IdPrefix, (object) this.TemplateId)
        };
