...
// Type: Kendo.Mvc.UI.ChartXAxis`1
...
{
  public class ChartXAxis<T> where T : class
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source8 = this.PlotBands.Select<ChartXAxisPlotBand<T>, Dictionary<string, object>>((Func<ChartXAxisPlotBand<T>, Dictionary<string, object>>) (i => i.Serialize()));
