...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisCrosshairTooltipBorderSettings`1
...
{
  public class StockChartNavigatorCategoryAxisCrosshairTooltipBorderSettings<T> where T : class
  {
