...
// Type: Kendo.Mvc.UI.ChartSeriesBorderSettings`1
...
{
  public class ChartSeriesBorderSettings<T> where T : class
  {
    ...
    public ClientHandlerDescriptor OpacityHandler { get; set; }
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      ClientHandlerDescriptor opacityHandler = this.OpacityHandler;
      double? nullable;
      if ((opacityHandler != null ? (opacityHandler.HasValue() ? 1 : 0) : 0) != 0)
      {
        dictionary1["opacity"] = (object) this.OpacityHandler;
      }
      else
      {
