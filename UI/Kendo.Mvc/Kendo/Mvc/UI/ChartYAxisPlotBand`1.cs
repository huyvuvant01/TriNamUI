...
// Type: Kendo.Mvc.UI.ChartYAxisPlotBand`1
...
{
  public class ChartYAxisPlotBand<T> where T : class
  {
    ...
    public ChartYAxisPlotBandLabelSettings<T> Label { get; } = new ChartYAxisPlotBandLabelSettings<T>();
