...
// Type: Kendo.Mvc.UI.ChartXAxisPlotBand`1
...
{
  public class ChartXAxisPlotBand<T> where T : class
  {
    ...
    public ChartXAxisPlotBandLabelSettings<T> Label { get; } = new ChartXAxisPlotBandLabelSettings<T>();
