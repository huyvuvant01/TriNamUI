...
// Type: Kendo.Mvc.UI.DiagramConnectionEditableSettingsTool`2
...
{
  public class DiagramConnectionEditableSettingsTool<TShapeModel, TConnectionModel>
    ...
    where TConnectionModel : class
  {
    ...
    public List<DiagramConnectionEditableSettingsToolButton<TShapeModel, TConnectionModel>> Buttons { get; set; } = new List<DiagramConnectionEditableSettingsToolButton<TShapeModel, TConnectionModel>>();
    ...
    public List<DiagramConnectionEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>> MenuButtons { get; set; } = new List<DiagramConnectionEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>>();
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source1 = this.Buttons.Select<DiagramConnectionEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramConnectionEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
      ...
      IEnumerable<Dictionary<string, object>> source2 = this.MenuButtons.Select<DiagramConnectionEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramConnectionEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
