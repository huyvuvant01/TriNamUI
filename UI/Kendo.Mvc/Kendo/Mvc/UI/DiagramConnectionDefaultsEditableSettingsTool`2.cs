...
// Type: Kendo.Mvc.UI.DiagramConnectionDefaultsEditableSettingsTool`2
...
{
  public class DiagramConnectionDefaultsEditableSettingsTool<TShapeModel, TConnectionModel>
    ...
    where TConnectionModel : class
  {
    ...
    public List<DiagramConnectionDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>> Buttons { get; set; } = new List<DiagramConnectionDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>>();
    ...
    public List<DiagramConnectionDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>> MenuButtons { get; set; } = new List<DiagramConnectionDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>>();
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source1 = this.Buttons.Select<DiagramConnectionDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramConnectionDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
      ...
      IEnumerable<Dictionary<string, object>> source2 = this.MenuButtons.Select<DiagramConnectionDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramConnectionDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
