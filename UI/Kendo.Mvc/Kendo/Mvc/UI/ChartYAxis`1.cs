...
// Type: Kendo.Mvc.UI.ChartYAxis`1
...
{
  public class ChartYAxis<T> where T : class
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      Dictionary<string, object> source6 = this.MinorTicks.Serialize();
      if (source6.Any<KeyValuePair<string, object>>())
        dictionary["minorTicks"] = (object) source6;
      Dictionary<string, object> source7 = this.MajorTicks.Serialize();
      if (source7.Any<KeyValuePair<string, object>>())
        dictionary["majorTicks"] = (object) source7;
      ...
      IEnumerable<Dictionary<string, object>> source8 = this.PlotBands.Select<ChartYAxisPlotBand<T>, Dictionary<string, object>>((Func<ChartYAxisPlotBand<T>, Dictionary<string, object>>) (i => i.Serialize()));
