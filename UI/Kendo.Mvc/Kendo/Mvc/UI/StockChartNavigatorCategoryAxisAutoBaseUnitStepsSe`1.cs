...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisAutoBaseUnitStepsSettings`1
...
{
  public class StockChartNavigatorCategoryAxisAutoBaseUnitStepsSettings<T> where T : class
  {
