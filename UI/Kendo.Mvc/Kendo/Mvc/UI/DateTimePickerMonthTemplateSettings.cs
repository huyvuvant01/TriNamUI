...
// Type: Kendo.Mvc.UI.DateTimePickerMonthTemplateSettings
...
{
  public class DateTimePickerMonthTemplateSettings
  {
    public Dictionary<string, object> Serialize()
    {
      ...
      if (this.ContentId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.DateTimePicker.IdPrefix, (object) this.ContentId)
        };
      ...
      if (this.EmptyId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.DateTimePicker.IdPrefix, (object) this.EmptyId)
        };
      ...
      if (this.WeekNumberId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.DateTimePicker.IdPrefix, (object) this.WeekNumberId)
        };
