...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisCrosshairTooltipPaddingSettings`1
...
{
  public class StockChartNavigatorCategoryAxisCrosshairTooltipPaddingSettings<T> where T : class
  {
