...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisLabelsDateFormatsSettings`1
...
{
  public class StockChartNavigatorCategoryAxisLabelsDateFormatsSettings<T> where T : class
  {
