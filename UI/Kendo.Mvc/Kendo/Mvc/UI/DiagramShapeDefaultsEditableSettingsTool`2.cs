...
// Type: Kendo.Mvc.UI.DiagramShapeDefaultsEditableSettingsTool`2
...
{
  public class DiagramShapeDefaultsEditableSettingsTool<TShapeModel, TConnectionModel>
    ...
    where TConnectionModel : class
  {
    ...
    public List<DiagramShapeDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>> Buttons { get; set; } = new List<DiagramShapeDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>>();
    ...
    public List<DiagramShapeDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>> MenuButtons { get; set; } = new List<DiagramShapeDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>>();
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source1 = this.Buttons.Select<DiagramShapeDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramShapeDefaultsEditableSettingsToolButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
      ...
      IEnumerable<Dictionary<string, object>> source2 = this.MenuButtons.Select<DiagramShapeDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>((Func<DiagramShapeDefaultsEditableSettingsToolMenuButton<TShapeModel, TConnectionModel>, Dictionary<string, object>>) (i => i.Serialize()));
