...
// Type: Kendo.Mvc.UI.FilterOperatorsNumberSettings`1
...
{
  public class FilterOperatorsNumberSettings<T> : OperatorsBase where T : class
  {
    public FilterOperatorsNumberSettings() => this.Operators = (IDictionary<string, string>) new Dictionary<string, string>();
