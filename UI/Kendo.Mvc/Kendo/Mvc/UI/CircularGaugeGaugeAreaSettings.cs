...
// Type: Kendo.Mvc.UI.CircularGaugeGaugeAreaSettings
...
{
  public class CircularGaugeGaugeAreaSettings
  {
    public Dictionary<string, object> Serialize() => this.SerializeSettings();

    public string Background { get; set; }

    public CircularGaugeGaugeAreaBorderSettings Border { get; } = new CircularGaugeGaugeAreaBorderSettings();

    public double? Height { get; set; }

    public CircularGaugeGaugeAreaMarginSettings Margin { get; } = new CircularGaugeGaugeAreaMarginSettings();
