...
// Type: Kendo.Mvc.UI.ImageEditorToolbarSettings
...
{
  public class ImageEditorToolbarSettings
  {
    public Dictionary<string, object> Serialize() => this.SerializeSettings();

    public List<ImageEditorToolbarSettingsItem> Items { get; set; } = new List<ImageEditorToolbarSettingsItem>();
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      IEnumerable<Dictionary<string, object>> source = this.Items.Select<ImageEditorToolbarSettingsItem, Dictionary<string, object>>((Func<ImageEditorToolbarSettingsItem, Dictionary<string, object>>) (i => i.Serialize()));
