...
// Type: Kendo.Mvc.UI.Fluent.AjaxDataSourceBuilderBase`2
...
namespace Kendo.Mvc.UI.Fluent
{
    ...
    where TDataSourceBuilder : AjaxDataSourceBuilderBase<TModel, TDataSourceBuilder>
  {
    ...
    public AjaxDataSourceBuilderBase(
    ...
    public virtual TDataSourceBuilder AccentFoldingFiltering(string culture)
    {
    ...
    public TDataSourceBuilder GroupPaging(bool enabled)
    {
