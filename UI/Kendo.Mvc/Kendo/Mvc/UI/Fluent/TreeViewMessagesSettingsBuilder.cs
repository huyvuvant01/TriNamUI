...
// Type: Kendo.Mvc.UI.Fluent.TreeViewMessagesSettingsBuilder
...
{
  public class TreeViewMessagesSettingsBuilder
  {
    public TreeViewMessagesSettingsBuilder(TreeViewMessagesSettings container) => this.Container = container;

    protected TreeViewMessagesSettings Container { get; private set; }
