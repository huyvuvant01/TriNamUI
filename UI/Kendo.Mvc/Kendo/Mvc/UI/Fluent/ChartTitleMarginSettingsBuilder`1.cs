...
// Type: Kendo.Mvc.UI.Fluent.ChartTitleMarginSettingsBuilder`1
...
{
  public class ChartTitleMarginSettingsBuilder<T> where T : class
  {
    public ChartTitleMarginSettingsBuilder(ChartTitleMarginSettings<T> container) => this.Container = container;

    protected ChartTitleMarginSettings<T> Container { get; private set; }
