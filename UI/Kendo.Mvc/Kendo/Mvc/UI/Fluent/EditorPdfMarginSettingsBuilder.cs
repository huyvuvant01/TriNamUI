...
// Type: Kendo.Mvc.UI.Fluent.EditorPdfMarginSettingsBuilder
...
{
  public class EditorPdfMarginSettingsBuilder
  {
    public EditorPdfMarginSettingsBuilder(EditorPdfMarginSettings container) => this.Container = container;

    protected EditorPdfMarginSettings Container { get; private set; }
