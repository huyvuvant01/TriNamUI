...
// Type: Kendo.Mvc.UI.Fluent.SortableCursorOffsetSettingsBuilder
...
namespace Kendo.Mvc.UI.Fluent
{
  ...
  {
    public SortableCursorOffsetSettingsBuilder(SortableCursorOffsetSettings container) => this.Container = container;

    protected SortableCursorOffsetSettings Container { get; private set; }
