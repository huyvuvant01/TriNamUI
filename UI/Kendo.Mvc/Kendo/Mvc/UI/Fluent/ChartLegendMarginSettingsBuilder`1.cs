...
// Type: Kendo.Mvc.UI.Fluent.ChartLegendMarginSettingsBuilder`1
...
{
  public class ChartLegendMarginSettingsBuilder<T> where T : class
  {
    public ChartLegendMarginSettingsBuilder(ChartLegendMarginSettings<T> container) => this.Container = container;

    protected ChartLegendMarginSettings<T> Container { get; private set; }
