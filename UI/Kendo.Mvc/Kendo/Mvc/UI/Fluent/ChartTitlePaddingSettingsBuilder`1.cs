...
// Type: Kendo.Mvc.UI.Fluent.ChartTitlePaddingSettingsBuilder`1
...
{
  public class ChartTitlePaddingSettingsBuilder<T> where T : class
  {
    public ChartTitlePaddingSettingsBuilder(ChartTitlePaddingSettings<T> container) => this.Container = container;

    protected ChartTitlePaddingSettings<T> Container { get; private set; }
