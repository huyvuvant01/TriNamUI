...
// Type: Kendo.Mvc.UI.NumericTextBoxLabelSettings`1
...
{
  public class NumericTextBoxLabelSettings<T> where T : struct
  {
    ...
    public Kendo.Mvc.UI.NumericTextBox<T> NumericTextBox { get; set; }
