...
// Type: Kendo.Mvc.UI.FileManagerViewsListSettings
...
{
  public class FileManagerViewsListSettings
  {
    ...
    protected virtual Dictionary<string, object> SerializeSettings()
    {
      ...
      if (this.EditTemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.FileManager.IdPrefix, (object) this.EditTemplateId)
        };
      ...
      if (this.AltTemplateId.HasValue())
        ...
        {
          HandlerName = string.Format("jQuery('{0}{1}').html()", (object) this.FileManager.IdPrefix, (object) this.AltTemplateId)
        };
