...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisMajorGridLinesSettings`1
...
{
  public class StockChartNavigatorCategoryAxisMajorGridLinesSettings<T> where T : class
  {
