...
// Type: Kendo.Mvc.UI.GridSortableSettings`1
...
{
  public class GridSortableSettings<T> where T : class
  {
    public Dictionary<string, object> Serialize()
    {
      Dictionary<string, object> dictionary1 = this.SerializeSettings();
      if (this.SortMode.HasValue)
      {
        Dictionary<string, object> dictionary2 = dictionary1;
        GridSortMode? sortMode = this.SortMode;
        ref GridSortMode? local = ref sortMode;
