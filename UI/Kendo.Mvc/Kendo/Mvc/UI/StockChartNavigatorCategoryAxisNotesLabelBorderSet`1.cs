...
// Type: Kendo.Mvc.UI.StockChartNavigatorCategoryAxisNotesLabelBorderSettings`1
...
{
  public class StockChartNavigatorCategoryAxisNotesLabelBorderSettings<T> where T : class
  {
