...
// Type: Kendo.Mvc.UI.ChartLegendTitleSettings`1
...
{
  public class ChartLegendTitleSettings<T> where T : class
  {
    ...
    public ChartLegendTitleBorderSettings<T> Border { get; } = new ChartLegendTitleBorderSettings<T>();

    public string Color { get; set; }

    public string Font { get; set; }

    public ChartLegendTitleMarginSettings<T> Margin { get; } = new ChartLegendTitleMarginSettings<T>();

    public ChartLegendTitlePaddingSettings<T> Padding { get; } = new ChartLegendTitlePaddingSettings<T>();
