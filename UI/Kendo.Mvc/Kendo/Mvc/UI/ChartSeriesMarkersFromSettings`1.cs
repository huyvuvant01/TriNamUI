...
// Type: Kendo.Mvc.UI.ChartSeriesMarkersFromSettings`1
...
{
  public class ChartSeriesMarkersFromSettings<T> where T : class
  {
    ...
    public ChartSeriesMarkersFromBorderSettings<T> Border { get; } = new ChartSeriesMarkersFromBorderSettings<T>();
