...
// Type: Kendo.Mvc.UI.SchedulerMessagesRecurrenceEditorMonthlySettings`1
...
{
  public class SchedulerMessagesRecurrenceEditorMonthlySettings<T> where T : class, ISchedulerEvent
  {
