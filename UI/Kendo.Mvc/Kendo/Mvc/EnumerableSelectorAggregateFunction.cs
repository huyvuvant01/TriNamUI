...
// Type: Kendo.Mvc.EnumerableSelectorAggregateFunction
...
namespace Kendo.Mvc
{
  public abstract class EnumerableSelectorAggregateFunction : EnumerableAggregateFunctionBase
  {
    ...
    {
      EnumerableSelectorAggregateFunctionExpressionBuilder expressionBuilder = new EnumerableSelectorAggregateFunctionExpressionBuilder(enumerableExpression, this);
